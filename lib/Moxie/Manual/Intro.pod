...
=head1 Without Moxie
    ...
    package BinaryTree {
        ...
        my sub _parent : prototype() lvalue { package DB; @DB::args = (); my () = caller(1); $DB::args[0]->{parent} }
        my sub _left   : prototype() lvalue { package DB; @DB::args = (); my () = caller(1); $DB::args[0]->{left}   }
        my sub _right  : prototype() lvalue { package DB; @DB::args = (); my () = caller(1); $DB::args[0]->{right}  }
